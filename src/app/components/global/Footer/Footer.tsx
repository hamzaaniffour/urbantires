      ...
      <div className="max-w-[90%] sm:max-w-[95%] md:max-w-[1000px] lg:max-w-[1000px] xl:max-w-[1250px] mx-auto">
        <div className="lg:flex gap-10">
          <div className="lg:w-4/12 mt-8 lg:mt-0">
            ...
            <div className="bg-pink-200 h-[10px] max-w-[135px] mb-5"></div>
            <p className="text-md text-slate-500 mb-5">At TastyEats, we celebrate the joy of cooking with easy, delicious recipes and helpful tips for every home chef’s culinary journey!</p>
            <div className="flex items-center gap-1.5">
              ...
              <ul className="flex items-center gap-1">
                {[
                  ...
                  <li key={href}>
                    <Link href={href}>
                      {React.cloneElement(icon, { className: "size-7 text-blue-950 transition-all duration-300 hover:text-pink-700" })}
                    </Link>
                  </li>
                ))}
              </ul>
          ...
          <div className="lg:w-2/12 mt-8 lg:mt-0">
            ...
            <div className="bg-pink-200 h-[10px] max-w-[125px] mb-5"></div>
            <Categories />
          </div>
          <div className="lg:w-2/12 mt-8 lg:mt-0">
            <h4 className="text-[21px] text-blue-950 font-bold -mb-3">Quick Links</h4>
            <div className="bg-pink-200 h-[10px] max-w-[120px] mb-5"></div>
            <QuickLinks />
          </div>
          <div className="lg:w-4/12 mt-8 lg:mt-0">
            <h4 className="text-[21px] text-blue-950 font-bold -mb-3">Keep In Touch</h4>
            <div className="bg-pink-200 h-[10px] max-w-[140px] mb-5"></div>
        ...
        <div className="border-t border-slate-200 my-2.5 pt-6 text-center mt-5">
          © 2024 <Link href="/" className="font-semibold">Tastyeats</Link>. All rights reserved.
        </div>
      </div>
    </footer>
  );
